...
fun MaterialListItem(
    ...
    val styledText = applyTextStyle(typography.h6, ContentAlpha.high, text)!!
    val styledSecondaryText = applyTextStyle(typography.body1, ContentAlpha.medium, secondaryText)
